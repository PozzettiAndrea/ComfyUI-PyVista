    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "PyVistaPreview" || nodeData.name === "PyVistaPreviewPlotter") {
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                window.addEventListener('message', createScreenshotHandler('pyvista-screenshot', iframe));
                window.addEventListener('message', createErrorHandler(infoPanel, "[PyVista]", iframe));
